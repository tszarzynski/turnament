...
test("pairPlayers should return correct pairings for 1 round", () => {
	...
	expect(
		pairPlayers(0)([player1, player2, player3, player4, player5]),
	).toStrictEqual([
		[1, -1],
		[2, -1],
		[3, -1],
...
test("pairPlayers should return correct pairings for 2 round", () => {
	...
	expect(
		pairPlayers(1)([player1, player2, player3, player4, player5]),
	).toStrictEqual([
		[1, 2],
		[3, 4],
	]);
...
test("pairPlayers should return correct pairings for 3 round", () => {
	...
	expect(
		pairPlayers(3)([player1, player2, player3, player4, player5]),
	).toStrictEqual([
		[1, 3],
		[5, 2],
	]);
